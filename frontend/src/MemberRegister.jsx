      ...
      <div className="relative">
        {Icon && (
          <div
            className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-200 z-10
              ${hasError ? "text-red-400" : "text-gray-400 group-focus-within:text-sky-500"}`}
          >
            <Icon size={18} />
          </div>
        )}
        ...
        <label
          className={`absolute transition-all duration-200 pointer-events-none
              ...
              ${hasError
              ? "text-red-500"
              : "text-gray-500 peer-focus:text-sky-600 peer-focus:top-2 peer-focus:text-xs peer-focus:font-medium peer-focus:transform-none"
            }`}
        >
      ...
      <div className="relative group">
        {Icon && (
          <div className={`absolute left-3 top-1/2 transform -translate-y-1/2 transition-colors duration-200 z-10
            ${hasValue ? "text-sky-500" : "text-gray-400 group-focus-within:text-sky-500"}`}>
            <Icon size={18} />
          </div>
        )}
        <select
          ...
          className={`w-full border-2 border-gray-200 rounded-xl bg-white/80 backdrop-blur-sm 
            transition-all duration-200 cursor-pointer hover:border-gray-300 focus:border-sky-500 focus:ring-4 focus:ring-sky-100
        ...
        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 pointer-events-none transition-colors duration-200 group-hover:text-gray-600 group-focus-within:text-sky-500">
          ...
          <form onSubmit={handleRegister} className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
              <div className="flex items-center mb-6">
                <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-sky-500 to-blue-500 rounded-lg mr-4 shadow-lg">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {form.severity && getSeverityDescription() && (
                  <div className="md:col-span-2 mt-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {form.monthly_income && getMonthlyIncomeDescription() && (
                  <div className="md:col-span-2 mt-2 p-3 bg-emerald-50 border border-emerald-200 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                {[
                  ...
                  <div key={doc.name} className="relative group">
                    <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 hover:border-sky-400 transition-colors duration-200 group-hover:bg-sky-50/50">
                      <div className="text-center">
                        <Upload className="w-8 h-8 text-gray-400 mx-auto mb-2 group-hover:text-sky-500 transition-colors duration-200" />
                        ...
                        <input
                          ...
                          accept={doc.accept}
                          className="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-sky-50 file:text-sky-700 hover:file:bg-sky-100 cursor-pointer"
                        />
                      </div>
                    </div>
                  </div>
